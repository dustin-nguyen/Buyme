...
<title>Search to question</title>
</head>
<body>
	<div class="controls">
	...
	try {
		...
		String choice3 = request.getParameter("qname");
		String start="SELECT * from question q left join answer a ON q.questID=a.questID";
		if (!choice3.equals("")) {
		start += " WHERE q.question like " + "\"%" + choice3 + "%\"";
		}
		ResultSet result = stmt.executeQuery(start);
		while (result.next()) {
			out.print("<h1>");
