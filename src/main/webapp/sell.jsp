	...
	<div class="sell-box">
		...
		<form method="post" action="selllogic.jsp">
			...
			<div class="textbox">
				<tr>
					<td>Initial Price</td>
					<td><input type="number" name="initalPrice"
						placeholder="Enter Initial Price" min="1" required></td>
				</tr>
			</div>
			<div class="textbox">
				<tr>
					<td>Secret Price</td>
					<td><input type="number" name="secretPrice"
						placeholder="Enter Secret Price" min="1" required></td>
				</tr>
			</div>
			<div class="textbox">
				<tr>
					<td>Increment</td>
					<td><input type="number" name="increment"
						placeholder="Enter Increment" min="1" required></td>
				</tr>
			</div>
			<div class="textbox">
				<tr>
					<td>Close Date</td>
					<td><input type="date" name="closeDate" min="2021-01-01"
						max="2022-12-31" required></td>
				</tr>
			</div>
			<div class="textbox">
				<tr>
